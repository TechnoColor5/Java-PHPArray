...
public class Assig2
{
	public static void main(String [] args)
	{
		...
		PHPArray<Integer> prevTest = new PHPArray<Integer>(12);
		for (int i = 1; i < 6; i++) {
			prevTest.put("pos"+i, new Integer(i));
		}

		while ((curr = prevTest.each()) != null)
		{
			System.out.println("Key: " + curr.key + " Value: " + curr.value);
		}
		System.out.println();
		...
		for (int i = 0; i < 5; i++) {
			System.out.println("Previous value: " + prevTest.prev());
		}
	}
